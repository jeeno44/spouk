...
@section('title')Редактировать сотрудника@stop
...
@section('content')
    <section>
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12">
                    {!! Form::model($user, ['method' => 'put', 'url' => '/college/teachers/'.$user->id, 'class' => 'panel panel-default']) !!}
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">Редактировать сотрудника</div>
                                ...
                                <div class="col-md-6">
                                    @foreach(\App\Models\AccessLevel::all() as $level)
                                        <div class="checkbox checkbox-inline checkbox-styled">
                                            <label>
                                                <input type="checkbox" class="" name="levels[]"
                                                       value="{{$level->id}}" @if($user->hasAccess($level->title)) checked @endif>

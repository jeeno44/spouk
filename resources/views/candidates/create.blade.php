...
@section('title')Новый абитуриент@stop
@section('content')
<section>
    <div class="section-body">
        <div class="row">
            <div class="col-lg-12">
                <form id="create-candidate" class="panel panel-default form-validate" enctype="multipart/form-data" method="post" action="/enroll/candidates">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-left">Новый абитуриент</div>
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane fade in" id="tab1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ['class' => 'form-control', 'required', 'data-placeholder' => 'Выберите специальности']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Дополнительные специальности/профессии</label>
                                    <div class="col-md-6">
                                        {!! Form::select('specialization[]', $specs, null,
                                        ['class' => 'form-control', 'id' => 'specializationSelect', 'size' => 10, 'multiple', 'required', 'data-placeholder' => 'Выберите специальности']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group-content">
                                                {!! Form::text('date_took', '', ['class' => 'form-control js-datepicker']) !!}
                                                <span class="help-block" style="display: none;"></span>
                                            </div>
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="tab2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" name="cert" class="hidden appdoc">
                                        <a class="append-doc" href="#" data-toggle="tooltip" title="Прикрепить скан"><i class="fa fa-paperclip fa-2x"></i> </a>
                                        <span></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="file" name="passport" class="hidden appdoc">
                                        <a class="append-doc" href="#" data-toggle="tooltip" title="Прикрепить скан"><i class="fa fa-paperclip fa-2x"></i> </a>
                                        <span></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="file" name="med" class="hidden appdoc">
                                        <a class="append-doc" href="#" data-toggle="tooltip" title="Прикрепить скан"><i class="fa fa-paperclip fa-2x"></i> </a>
                                        <span></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="file" name="snils" class="hidden appdoc">
                                        <a class="append-doc" href="#" data-toggle="tooltip" title="Прикрепить скан"><i class="fa fa-paperclip fa-2x"></i> </a>
                                        <span></span>
                                    </div>
                                </div>

...
@section('title')Редактировать абитуриента@stop
@section('content')
    <section>
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12">
                    {!! Form::model($candidate, ['method' => 'put', 'url' => '/enroll/candidates/'.$candidate->id, 'class' => 'panel panel-default']) !!}
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-left">Редактировать абитуриента</div>
                            ...
                            <div class="active tab-pane fade in" id="tab1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ['class' => 'form-control', 'data-placeholder' => 'Выберите специальности']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Поступает на специальности/профессии</label>
                                    <div class="col-md-6">
                                        {!! Form::select('specialization[]', $specs, $candidate->specializations->lists('id')->toArray(),
                                        ['class' => 'form-control', 'id' => 'specializationSelect', 'size' => 10, 'multiple', 'data-placeholder' => 'Выберите специальности']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-group-content">
                                                {!! Form::text('date_took', $candidate->date_took != '0000-00-00' ? date('d.m.Y', strtotime($candidate->date_took)) : '', ['class' => 'form-control js-datepicker']) !!}
                                                <span class="help-block" style="display: none;"></span>
                                            </div>
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>

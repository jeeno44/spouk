                                ...
                                <div class="active tab-pane fade in" id="tab1">
                                    ...
                                    <div class="form-group no-padding-top">
                                        ...
                                        <div class="col-md-4 text-right">
                                            @if(!empty($statement))
                                                <a class="btn btn-info btn-xs" href="{{$statement->docx_link}}" target="_blank">Скачать заявление</a>
                                            @endif
                                            <a class="btn btn-success btn-xs" href="/generateDoc/{{$candidate->id}}">Сгенерировать заявление</a>
                                        </div>
                                    </div>
                                    <div class="form-group no-padding-top">

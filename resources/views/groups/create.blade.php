...
@section('title')Новая группа@stop
...
@section('content')
    <section>
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12">
                    <form class="panel panel-default" method="post" action="/dec/groups">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">Новая группа</div>
                        ...
                        <div class="panel-body form-horizontal">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-6">
                                     {!! Form::number('number_course', null, ['class' => 'form-control']) !!}
                                </div>
                            </div>
